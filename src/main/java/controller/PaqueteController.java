...
public class PaqueteController {
    ...
    public ResponseEntity<String> crearPaquete(@RequestBody Paquete nuevo) {
        ...
        // Validacion  Estado Válido (NUEVA INTEGRACIÓN)
        if (!esEstadoValido(nuevo.getEstado())) {
            return ResponseEntity.badRequest().body("Error: Estado invalido. Use: PENDIENTE, EN_TRANSITO o ENTREGADO.");
        }
